 ...
 * 
 * This table puts the parser in the mode of parsing a explanation group.
 * 
 * The object that is currently being parsed can be found at:
 *   m_Parser.m_CurrentGroup.m_Object
 *
 * Note that this table does not initialize the current object
 ...
 * end( EXPLANATION_TAG ) --> GROUP_PARSE_STATE
 *
 * In Edges
 * --------
...
public class ExplanationTable extends ParseStateTable {
    
    protected LabelStateTable m_Labels;
    protected ActiveIfTable   m_ActiveIf;
    
    public ExplanationTable( SpecParser parser ) {
	super( parser );
	...
	if ( name.equals( SpecParser.EXPLANATION_TAG ) ) {
