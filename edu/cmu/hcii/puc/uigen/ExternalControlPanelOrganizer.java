/**
 * ExternalControlPanelOrganizer.java
 *
...
public class ExternalControlPanelOrganizer extends ControlOrganizer {

    //**************************
    // Member Variables
    //**************************

    protected boolean m_bScrollPanels;
    ...
    public ExternalControlPanelOrganizer( UIGenerator ui,
					  ApplianceState pState,
					  Vector vChildren,
					  Vector vDependencies,
					  boolean bScrollPanels
					  ) {
	super( ui, pState );
