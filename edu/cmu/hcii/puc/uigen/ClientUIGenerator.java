...
public class ClientUIGenerator extends UIGenerator {
    ...
    public ClientUIGenerator( MenuBar m ) {
	...
	LayoutVariables pVars = new LayoutVariables();
	...
	m_pInterfaceRoot.doSizing( pVars );

	m_pInterfaceRoot.doLayout( m_Panel, pVars );
